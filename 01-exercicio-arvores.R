...
# aqui definimos a implementação do algoritmo que nós vamos usar
...
mape(Hitters1_com_previsao, truth = HmRun, estimate = HmRun_pred)
mae(Hitters1_com_previsao, truth = HmRun, estimate = HmRun_pred)
mase(Hitters1_com_previsao, truth = HmRun, estimate = HmRun_pred)
